# Translate an audio file into a CQT representation, saved as an OpenEXR image
# And the complement - interpret an OpenEXR image as CQT, invert it, and save the resulting audio file
...
C = librosa.cqt(y=y, sr=sr, hop_length=hop_length, n_bins=8*bins_per_octave, bins_per_octave=bins_per_octave)
...
y_hat = librosa.icqt(C=C_output_np, sr=sr, hop_length=hop_length, bins_per_octave=bins_per_octave)
